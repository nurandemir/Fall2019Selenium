...
public class ActionsTests {
    ...
    @Test
    public void jqeryMenuTest(){
        driver.get("http://practice.cybertekschool.com/jqueryui/menu");
        //Task: hover on enabled, download, click on PDF

        WebElement enabled=driver.findElement(By.xpath("//a[@id='ui-id-3']")); // By.id("ui-id-3")
        WebElement downloadBtn=driver.findElement(By.xpath("//a[@id='ui-id-4']"));
        WebElement pdfBtn=driver.findElement(By.xpath("//a[@id='ui-id-5']"));

        actions.moveToElement(enabled).pause(1000).
                moveToElement(downloadBtn).pause(1000).click(pdfBtn).build().perform();
...
//build() is needed when you have couple of actions together
