...
public class RegistrationForm {
   ...
   // private String firstNameLocator="firstname";you do not remember attribute
...
driver.findElement(signUpBy).click();
    ...
    public void verifyFirstNameLengthTest(){
        ...
        WebElement warningMessage=driver.findElement(By.xpath("//small[text()='first name more than 2 and less than 64 characters long']"));
