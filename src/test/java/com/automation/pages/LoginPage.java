...
public class LoginPage {
    ...
    //private force everyone to use method, keep organize,

    @FindBy(css="[class='alert alert-error']")
    private WebElement warningMessage;

    public LoginPage() {// create constructor
        //to connect our webdriver, page class and pagefactory
        //PageFactory - used to use @FindBy annotations
        //PageFactory - helps to find elements easier
        PageFactory.initElements(Driver.getDriver(), this);// this is the class where we are gonna use find annotation
                   // helps us enable to connect our webdriver and pagefactory
    }
    /**
