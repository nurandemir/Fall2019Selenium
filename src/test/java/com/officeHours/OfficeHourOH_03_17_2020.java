...
public class OfficeHourOH_03_17_2020 {
...
//        state.sendKeys(contact1.get("State"));
   ...
   Assert.assertEquals(uiPhone, contact1.get("Phone"));
        ...
        String uiCompleteAddress=driver.findElement(By.tagName("address")).getText();
        String cityWithState=(contact1.get("City")+" "+contact1.get("State")+" "+contact1.get("Country")+
